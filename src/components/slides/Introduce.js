      ...
      <div className="Introduce-sections">
        <section>
          ...
          <div>
            ...
            <StrongI
              text={
                "개발자라는 직업을 만났습니다. 무언가를 고민하고, 만들고, 기여하여 사람들의 삶에 도움을 준다는 개발자라는 직업은 큰 매력으로 다가왔습니다."
              }
            />
            프로그래밍을 공부한 9개월이 제 인생에서 가장 열심히 했던 때였던 것
            같습니다. 그 후, 제 전공을 살려 일본에서 IT관련 업무를 1년간 마쳤고,
            이제 한국으로 돌아와 제 2의 개발자의 길을 시작해보려 합니다.
          </div>
        </section>
        ...
        <section>
          ...
          <div>
            A.처음 HTML 공부를 할 때 태그를 통해 웹 사이트간 이동을 할 때는
            엄청난 충격을 받았습니 다.{" "}
            <StrongI
              text={
                "웹은 거대한 바다이고 웹 개발자라는 것은 거대한 바다 어느 곳에 자신만의 섬을 만드는 것이라 생각합니다. 태그를 통해 섬(사이트)에 닻을 내려 정박하고 컨텐츠를 소비하는 것이죠."
              }
            />
            그렇게 상상을 하고 나니 웹에 너무나도 큰 매력을 느꼈고, 나만의
            웹사이트를 만들어 보고 싶다 는 생각까지 하였습니다. 특히 유저와
            상호작용을 하는 프론트엔드 개발은 다른 길을 생각하지도 않고 몰두하게
            만들었습니다.
          </div>
        </section>
