      ...
      <div className="Introduce-container">
        <section>
          ...
          <div>
            ...
            해외여행을 다녀와 찍었던 사진으로 여행 영상을 만들기도 했습니다.
            전역 후 복학하여 미래에 대한 불안에 방황하고 있었을 때,
            <StrongI
              text={
                "개발자라는 직업을 만났습니다. 무언가를 고민하고, 만들고, 이바지하여 사람들의 삶에 도움을 준다는 개발자라는 직업은 저에게 큰 매력으로 다가왔습니다."
              }
            />
            개발자의 길을 결심하고 프로그래밍을 공부한 9개월이 제 인생에서 가장
            열심히 했던 때였던 것 같습니다. 그 후, 제 전공을 살려 일본에서 IT
            업무를 1년간 마쳤고, 이제 한국으로 돌아와 제2의 개발자의 길을
            시작해보려 합니다.
          </div>
        </section>
        ...
        <section>
          <h3>Q. 왜 웹 개발자인가?🤔</h3>
          <div>
            A.처음 개발 공부로써 HTML을 접했을 때 엄청난 충격을 받았습니다.
            지금까지 무심코 보아왔었던 웹이 이런 식으로 보여지고 있구나,
            <StrongI
              text={
                "웹은 거대한 바다이고 웹 개발자라는 것은 거대한 바다 어느 곳에 자신만의 섬을 만드는 직업이구나."
              }
            />
