      ...
      <div className="Introduce-sections">
        <section>
          ...
          <div>
            ...
            열심히 했던 때였던 것 같습니다. 그 후, 제 전공을 살려 일본에서
            IT관련 업무를 1년간 마쳤고, 이제 한국으로 돌아와 제 2의 개발자의
            길을 시작해보려 합니다.
          </div>
        </section>
        ...
        <section>
          ...
          <div>
            ...
            엄청난 충격을 받았습니 다. 웹은 거대한 바다이고 웹 개발자라는 것은
            거대한 바다 어느 곳에 자신만의 섬을 만드는 것이라 생각합니다. 태그를
            통해 섬(사이트)에 닻을 내려 정박하고 컨텐츠를 소비하는 것이죠.
